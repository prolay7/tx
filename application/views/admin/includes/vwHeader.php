...
<html lang="en">
  <head>
    ...
    <!-- bootstrap & fontawesome -->
		...
		<link rel="stylesheet" href="<?php echo HTTP_CSS_PATH; ?>waitMe.css" />
		<!-- ace styles -->
		...
		<script src="<?php echo HTTP_JS_PATH; ?>waitMe.js"></script>
							...
							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar notificationMsg">
										<li><a href = "<?php echo base_url(); ?>admin/messages/">View Messages</a></li>
									</ul>
								</li>
