...
<!-- /section:basics/navbar.layout -->
		<div class="main-container" id="main-container">
			...
			echo form_open('admin_jobpost/resend_invoice',$attributes); 
			...
			$invoicesql="select `description` from `invoice` where `bid_id`='$id'";
			$invoiceval=$this->db->query($invoicesql); 
			$invoicefetch=$invoiceval->row();
			$invoice_desc=$invoicefetch->description;
