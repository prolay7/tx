      ...
      * {font-family:'Lucida Grande', sans-serif;}
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-content">
                ...
                echo form_open('cs_admin/pendingEditApproval/'.$fetch->id, $attributes);
                ?>
...
<!--                    </div>-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <a href="<?php echo base_url() ?>cs_admin/viewer/<?php echo $fetch->id ?>/<?php echo base64_encode($view[$i]) ?>" class="btn btn-success" target="_blank"><?php echo $str ?></a>
...
function removealert(id,file)
{
	...
	else
	{
        ...
        if ($fileUpload>1){
         window.location.href="<?php echo base_url(); ?>cs_admin/removefile/"+id+"/"+file;
        }else{
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            if (response != null || response != '') {
                                                ...
                                                $('#lineMonth').attr('readonly', 'readonly');
                                                $('#lineYear').attr('readonly', 'readonly');
