							  ...
							  ?>
                                ...
                                <div class="form-group lineNumberInput" style="display:block;">
            						...
            						<div class="col-sm-9">
            							...
            							<span style="float:left;">&nbsp;L&nbsp;</span>
            						  	<input name="lineNumber" type="number" id="lineNumber" class="col-xs-2 col-sm-1" value="<?php echo set_value('lineNumber') ?>" />
            						</div>
                                ...
                                <div class="form-group" id="documents-container">
                                    <div class="col-sm-9 col-sm-offset-3" style="margin-bottom: 10px;">
                                        <a href="javascript: void(0);" id="toggle-upload-more" style="text-decoration: none;"><i class="ace-icon glyphicon glyphicon-plus"></i>&nbsp;&nbsp;Upload documents</a>
                                    </div>

                                    <div class="uploader-wrapper">
                                        <div class="col-sm-9 col-sm-offset-3 first" style="margin-bottom:10px;">
                                            <div class="col-sm-1" id="row-num" style="text-align: right;">#<span class="row-num-val">1</span></div>
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-4">
                                                <div id="translator-field">
                                                    <input type="text" name="translator" class="translator-name" style="width: 100%" placeholder="Type translator name here" value="<?php echo set_value('translator') ?>" />
                                                    <input type="hidden" class="translator-id" name="document[translator][]" value="<?php echo set_value('document[translator][]') ?>" />
                                                </div>
                                            </div>

                                            <div class="col-sm-1">
                                                <a href="javascript:void(0)" id="toggle-remove-uploader" style="margin-top:5px; display:none;"><i class="ace-icon glyphicon glyphicon-trash"></i></a>
                                            </div>
                                        </div>
                                    </div>
							    </div>
										...
										<div class="col-sm-9">
                                            <select name="language_from" id="language_from" class="validate[required]" style="width: 42%">
                                                ...
                                                <?php foreach ($lang as $lang1) { ?>
                                                    ...
                                                    <option value="<?php echo $lang1->id; ?>" selected="selected"><?php echo $lang1->name; ?></option>
                                                    <?php } else { ?>
                                    ...
                                    <div class="form-group" id="proofreadQuestion">
			                            ...
			                            <div class="col-sm-9" style="padding-top:5px">
			                                <input type="radio" class="form-input input-radio proofread_required" value="1" id="proofread_required" name="proofread_required" checked /> Yes
			                        ...
			                        <div class="form-group" id="proofreadSettings">
			                            ...
			                            <div class="col-sm-9" style="padding-top:5px">
			                                <input type="radio" class="form-input input-radio proofreadType" value="editing" id="proofreadType" name="proofreadType" checked="" /> Editing |
...
$(document).ready(function() {
    ...
    $(document).on('click', '#toggle-submit-review-job', function (e) {
        ...
        if ( $('input').is('[readonly]') ) {
            if (form_submit) {
                $("#addreviewjobpost").trigger('submit');
            }
        } else {
            $.ajax({
                url: "<?php echo base_url() ?>admin_review/check/line-number",
