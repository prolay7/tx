...
?>
		...
		<div class="main-container" id="main-container">
							...
							<div class="col-xs-12">
							  ...
							  ?>
								...
								<div>
								    ...
								    echo form_open('admin_review/joblist', $attributes);
                             ...
                             <button class="btn btn-info btn-reser btn-sm" onClick="reload()" >Reset</button>
                                    <div class="clearfix">
                                     ...
                                     <?php
                                            ...
                                            <a href="<?php echo base_url() ?>admin_review/viewsummary/<?php echo $val['job_id'] ?>"><?php echo $val['name']; ?>&nbsp;/&nbsp;<?php echo $val['lineNumberCode'] ?></a>
                                            </td>
            ...
            //                                  if($job_type==0)
                                 ...
                                 <a class="green" href="<?php echo base_url(); ?>admin_review/edit/<?php echo $val['job_id']; ?>">
                   ...
                   <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                        ...
                                        <?php
											...
											{ ?>
                                            <tr><td colspan="7" align="center">No Jobs Found!</td></tr>
                                            <?php
...
function reload()
{
window.location.href="<?php echo base_url().'admin_review/joblist/'?>";
}
</script>
<script>
function goBack() {
