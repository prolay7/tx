				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Hiring Job List</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="col-xs-12">
                               ...
                               <?php } ?>
								...
								<div>
								    ...
								    echo form_open('admin/hiringjob', $attributes);
                             ...
                             <button class="btn btn-info btn-reser btn-sm" onClick="reload()" >Reset</button>
                                    <div class="clearfix">
                                     ...
                                     <?php
                                            ...
                                            <tr>
                                            <td>
                                            <a href="<?php echo base_url(); ?>admin_jobpost/viewsummary/<?php echo $val['id']; ?>" target="_blank" ><?php echo $val['name']; ?>&nbsp;/&nbsp;<?php echo $val['lineNumberCode'] ?></a>
                                        ...
                                        {
										?>
                                        <td><a href="<?php echo base_url(); ?>admin_jobpost/viewsummary/<?php echo $val['id']; ?>" target="_blank" class="btn btn-success" > <?php echo $bid_num; ?>&nbsp;Bids</a></td>            <?php
										}
                                        else
                                        {
										?>
                   ...
                   <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                        ...
                                        <?php
											...
											{ ?>
                                            <tr><td colspan="10" align="center">No Jobs Found!</td></tr>
                                            <?php
