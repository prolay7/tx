		...
		<div class="main-content-inner">
			...
			<div class="page-content">
				<div class="page-header">
					...
					<?php
						$array = [$this->workflow_model->get_order('LINE_NO')[0]->stage_order=>'LINE_NO',$this->workflow_model->get_order('TRANS_JOB')[0]->stage_order=>'TRANS_JOB',$this->workflow_model->get_order('DATE_RECIEVED')[0]->stage_order=>'DATE_RECIEVED',$this->workflow_model->get_order('DATE_DUE')[0]->stage_order=>'DATE_DUE',$this->workflow_model->get_order('TRANS_NAME')[0]->stage_order=>'TRANS_NAME',$this->workflow_model->get_order('LANGUAGE_FROM')[0]->stage_order=>'LANGUAGE_FROM',$this->workflow_model->get_order('LANGUAGE_TO')[0]->stage_order=>'LANGUAGE_TO'];
						print_r($array);
									...
									<?php
										if(!empty($wstages)){
											foreach ($wstages as $key => $value){
												if(in_array($value->stage_column,$inlude_head)){
