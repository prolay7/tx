...
<!-- basic scripts -->
  ...
  <body>
							...
							$list_query=mysql_query("select * from translator where id='". $id."'");
                            ...
                            ?>
                            <h3 style="color:#6fb3e0 ;padding-left: 20px;" ><strong > Invitation to the Translator</strong></h3>
  <div class="col-xs-12">
                            ...
                            <div class="col-sm-9">
                            <input name="email" id="email" class="form-control col-xs-5 col-sm-5" value="<?php echo $rows['email_address']; ?>" type="text" readonly>
                            ...
                            <div class="col-sm-9">
                            <textarea name="description" id="description" class="form-control col-xs-5 col-sm-5 " > </textarea>
                            </div>
                            </div>
                            </div>
