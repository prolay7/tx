		...
		<div class="main-content-inner">
			...
			<div class="page-content">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Workflow List<a class="btn btn-primary pull-right btn-xs" style="margin-top: -4px;" data-toggle="modal" data-target="#myModal">Add Stage</a>
					...
					<!--div class="table-responsive" -->
						...
						?>
							<table class="table table-striped table-bordered " id="editabletable" style="font-size: 10px; font-weight: 600;">
								<thead>
...
#workflow_list{ position: relative; overflow: auto; padding: 10px; margin-top: 10px; }
#editabletable{ width: auto; margin-top: 35px; max-height: 200px;}
#editabletable thead{ position: absolute; top: 0; left: 10px;table-layout: fixed;}
#editabletable thead th:first-child{ width: 60px;min-width: 60px; }
#editabletable thead th:nth-child(2){ width: 200px;min-width: 200px; }
#editabletable thead th{ width: 150px; min-width: 150px; padding:8px; }
#editabletable tbody{ max-height: 300px;}
#editabletable tr td:first-child{ min-width: 60px; width: 60px; }
#editabletable tr td:nth-child(2){ min-width: 200px;width: 200px; }
#editabletable tr td{ width: 150px; min-width: 150px; padding: 8px;}
