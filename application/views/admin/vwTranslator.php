                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="design-reset"><a
                                    href="<?php echo base_url() . 'admin_regtranslator/resettranslator'; ?>"
                        ...
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th >Operations<?php if($this->uri->segment(2)!="" && $this->uri->segment(2) > 0){ ?> <span>
                                            <input type="checkbox" id="selecctall"/> Selecct All</span>
                                        <input type="submit" class="btn btn-danger" value="Multiple Invitation" /><?php }?>
                                ...
                                if ($preg != false) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            <?php if($row['verified']==2 && $row['de_act_status']==1) {  ?>
                                        <td>
                                            <a class="btn btn-block btn-danger btn-xs" href="<?php echo base_url(); ?>admin_translator/reactive_account/<?php echo $row['id']; ?>" onclick="return confirm('Are you sure, you want to Reactivate the account?')">Deactive</a>
...
<?php } else {?>
                                                ...
                                                if($admin_type==1 || $admin_type==5){
                                                    ?>
                                                    <td>
                                                        <a class="btn btn-block btn-success btn-xs" href="<?php echo base_url(); ?>admin_translator/deactive_account/<?php echo $row['id']; ?>" onclick="return confirm('Are you sure, you want to Deactive the account?')"> Active</a>
                                               ...
                                               <?php }else{?>
                                                    <td>
                                                        <a class="btn btn-block btn-success btn-xs"> Active</a>
                                                    </td>
                                               <?php }
                                                ?>
                                        ...
                                        <td>
                                            ...
                                            <!--                                                    <a class="green"-->
                                            <!--                                                       href="-->
                                            <?php //echo base_url(); ?><!--admin_translators/edit/-->
                                            <?php //echo $job; ?><!--/--><?php //echo $row['id']; ?><!--">-->
                                            <!--                                                        <i class="ace-icon fa fa-pencil bigger-130"></i> </a>-->
                                            <!--                                                --><?php //} else { ?>
                                            <!--                                                    <a class="green"-->
                                            <!--                                                       href="-->
                                            <?php //echo base_url(); ?><!--admin_translators/edittranslator/-->
                                            <?php //echo $row['id']; ?><!--">-->
                                            <!--                                                        <i class="ace-icon fa fa-pencil bigger-130"></i> </a>-->
                                            <!--                                                --><?php //} ?>
                                            &nbsp;
                                            ...
                                            <?php //echo $row['id']; ?><!--','-->
                                            <?php //echo $job; ?><!--')"><i-->
                                            <!--                                                                class="ace-icon fa fa-trash bigger-130"></i></a>&nbsp;-->
                                            <!--                                                --><?php //} else { ?>
                                            <!--                                                    <a href="javascript:void(0);" class="btn btn-danger"-->
                                            <!--                                                       onclick="thisisdelete('-->
                                            <?php //echo $row['id']; ?><!--')"><i-->
                                            <!--                                                                class="ace-icon fa fa-trash bigger-130"></i></a>&nbsp;-->
                                            <!--                                                --><?php //}
                                            //                                                }
...
<!--                  data-id="--><?php //$transid = $row['id'] ?><!--"> Invite</button>-->
                                                ...
                                                <a class="various btn btn-success btn-xs" data-fancybox-type="iframe"
                                                   href="<?php echo base_url(); ?>admin_translator/viewdemo/<?php echo $row['id']; ?>/<?php echo $job; ?>">Invite</a>

                                            <?php } ?>

                                            <a class="btn btn-success btn-xs"
                                               href="<?php echo base_url(); ?>admin/translatorreview/<?php echo $row['id']; ?>">Feedback</a>
