				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Add Translator Email</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
							  ...
							  //form validation
							  echo form_open_multipart('admin/translator/add', $attributes);
							  ?>
                                	...
                                	<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="first_name" type="text" id="fname" class="col-xs-10 col-sm-5 validate[required] text-input" value="" />
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input name="last_name" type="text" id="lname" class="col-xs-10 col-sm-5 " value="" />
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input name="email" type="text" id="email" class="col-xs-10 col-sm-5 validate[required],custom[email]" value="" />
										</div>
									</div>
