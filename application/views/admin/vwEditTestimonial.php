...
<script type="text/javascript">
    ...
    ?>
		...
		echo form_open_multipart('admin/editprof/'.$this->uri->segment(3).'', $attributes); 
		?>
                                     <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Name* </label>

										<div class="col-sm-9">
					<input name="name" type="text" id="name" class="col-xs-10 col-sm-5 validate[required]" value="<?php echo $results[0]['name'];?>" />
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
					<input name="designation" type="text" id="designation" class="col-xs-10 col-sm-5 validate[required]" value="<?php echo $results[0]['designation'];?>" />
										</div>
									</div>
                                    <div class="form-group">
       ...
       <textarea name="desc" id="desc" class="col-xs-10 col-sm-5 validate[required]"><?php echo $results[0]['desc'];?></textarea>
										</div>
									</div>
                                    
              <?php if($results[0]['image']!="" && file_exists("./uploads/testimonial/".$results[0]['image'])) { ?>
                <div class="form-group" style="overflow:hidden;">
                    <div class="col-md-offset-3 col-md-8" style="overflow:hidden;">
                        <img src="<?php echo base_url(); ?>uploads/testimonial/<?php echo $results[0]['image']; ?>" class="img-responsive" style="max-height:300px; max-width:300px;"  />
                    </div>
 ...
 <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Select Image(png,jpeg,jpg,gif)(300 X 300)* </label>
										...
										<div class="col-sm-9">
						<input name="file" type="file" id="testimonial" class="col-xs-10 col-sm-5" value="" />
										</div>
									</div>   
