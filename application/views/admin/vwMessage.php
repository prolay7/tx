...
<!-- /section:basics/navbar.layout -->
		<div class="main-container" id="main-container">
			...
			echo form_open('admin_jobpost/send_message',$attributes); 
			...
			$transsql="select * from `translator` where `id`='$trans_id'";
			$transval=$this->db->query($transsql); 
			$transfetch=$transval->row();
			$trans_firstname=$transfetch->first_name;
			$trans_lastname=$transfetch->last_name;
            ...
            <!-- <input name="comp_time" id="comp_time"  type="hidden" value="<?php echo $comp_time; ?>">-->
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
 <input name="job_title" id="trans_name" class="col-xs-10 col-sm-5 validate[required]"  type="text" value="<?php echo $trans_firstname;?> &nbsp; <?php echo $trans_lastname;?>" readonly>
                </div>
            </div>
 ...
 <input name="job_price" id="job_price" class="col-xs-10 col-sm-5 validate[required]"  type="text" value="$<?php echo $bid_price; ?>" readonly>
             ...
             <?php if($award==1) {?>  
                ...
                <div class="col-sm-9">
                    <input name="award_date" id="award_date" class="col-xs-10 col-sm-5 validate[required]"  type="text" value="<?php echo date('d-m-Y',strtotime($awarded_date)); ?>" readonly>
                </div>
                <?php } ?>
            </div>
                ...
                <div class="col-sm-9">
                    <textarea name="message"  class="col-xs-10 col-sm-5 validate[required]"></textarea>
                    
                </div>
            </div>                          
                  <div class="form-group"> 
           <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Select File(pdf,doc,docx,xls,txt,jpg,jpeg,png,zip): </label>                <div class="col-sm-9">
              	  <input type="file" name="file" id="file" size="20" class="col-xs-10 col-sm-5 ">
                </div>
             </div>  
