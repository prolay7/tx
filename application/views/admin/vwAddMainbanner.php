...
<!-- /section:basics/navbar.layout -->
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Add Mainbanner</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
							  ...
							  //form validation
							  echo form_open_multipart('admin/mainbanner/add', $attributes);
							  ?>
                                	...
                                	<div class="form-group">
										...
										<div class="col-sm-9">
					<input name="title" type="text" id="title" class="col-xs-10 col-sm-5 validate[required] text-input" value="" />
										</div>
									</div>
								...
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tag Line* </label>
										...
										<div class="col-sm-9">
			<input name="tag_line" type="text" id="tag_line" class="col-xs-10 col-sm-5 validate[required]" value="" />
										</div>
									</div>                                    
   ...
   <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Select Image(gif,jpg,jpeg,png)(2000 X 855)* </label>
										...
										<div class="col-sm-9">
						<input name="file" type="file" id="mainbanner" class="col-xs-10 col-sm-5 validate[required]" value="" />
										</div>
									</div>
