			...
			<div class="main-content">
                ...
                <input type="hidden" name="prefile" size="20" class="col-xs-10 col-sm-5" value="<?php echo $fetch->file; ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="language_from" class="col-xs-10 col-sm-5 validate[required]" id="language_from">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Translate To*</label>
                             <div class="col-sm-9">
                                ...
                                <select name="job_language" class="col-xs-10 col-sm-5 validate[required]" id="language">
                                    <option value=""> Select Language </option>
                                ...
                                <input type="hidden" name="language__val" value="<?php echo $lang_to; ?>">
                        <div class="form-group">
...
<script type="text/javascript" src="<?php echo HTTP_ASSETS_PATH_ADMIN; ?>js/select2.js"></script>
