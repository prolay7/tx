								 ...
								 <div style="clear:both"></div>
								  ...
								  <?php
									...
									<div class = "tag-field" style="clear:both;">
                                        <a href="<?php echo base_url() ?>front/document/viewer1/<?php echo $fetch1->id ?>" class="tag-field" style="margin:0px;" target="_blank"><?php echo $str; ?></a>
                                    </div>
									<?php }} ?>
								  </div>
								  <!-- Cleaner -->
                                ...
                                $language_name=$fetch6->name;						 ?>
                                    ...
                                    if ($results[0]['file']) {
                                     $files = explode('##', $results[0]['file']);
                                      ...
                                      <div class = "tag-field" style="clear:both;">
                                          <a href="<?php echo base_url() ?>front/document/viewer1/<?php echo $results[0]['id'] ?>" class="tag-field" style="margin:0px;" target="_blank"><?php echo $str; ?></a>
                                      </div>
                                      <?php }} ?>
                                    <?php
                                       }
