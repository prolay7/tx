                                    ...
                                    <tr style="width:100%;margin:0;padding:0">
                                        <td colspan="4" style="border:1px solid #d4d4d4;width:100%;background:white;border-radius:10px;padding:20px;text-align:center" align="center">
                                            ...
                                            <p style="color:#003366;font-family:Helvetica,Arial,sans-serif;font-size:18px;margin:0 0 5px;padding:0;text-align:left">
                                             ...
                                             A person is contact with translator exchange.
                                            </p>
                                            
                                            <table style="width:640px;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#003366;text-align:left">
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Contact Person Name</th>
                                              ...
                                              <tbody>
                                                 <tr>
                                                     ...
                                                     <td style="background:#efefef;padding:10px;color:#003366"> <?php echo $first_name; ?>&nbsp; <?php echo $last_name; ?></td>
                                              ...
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Address</th>
                                              ...
                                              <tbody>
                                                 <tr>
                                                     ...
                                                     <td style="background:#efefef;padding:10px;color:#003366"> <?php echo $address; ?> </td>
                                              ...
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Phone Number</th>
                                              ...
                                              <tbody>
                                                 <tr>
                                                     ...
                                                     <td style="background:#efefef;padding:10px;color:#003366"><?php echo $phone;?></td>
                                            ...
                                            <table style="width:640px;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#003366;text-align:left">
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Message</th>
