                                    ...
                                    <tr style="width:100%;margin:0;padding:0">
                                        <td colspan="4" style="border:1px solid #d4d4d4;width:100%;background:white;border-radius:10px;padding:20px;text-align:center" align="center">
                                            ...
                                            <p style="color:#003366;font-family:Helvetica,Arial,sans-serif;font-size:18px;margin:0 0 5px;padding:0;text-align:left">
                                             ...
                                             You are invited from Translator Exchange
                                            </p>
                                            ...
                                            <table style="width:640px;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#003366;text-align:left">
                                              ...
                                              <tbody>
                                                 <tr>
                                                     ...
                                                     <!--<td style="background:#efefef;padding:10px;color:#003366"><a href="<?php echo base_url(); ?>job/<?php echo $job_alias; ?>"> <?php echo $job_name; ?></a></td>-->
                                                     <td style="background:#efefef;padding:10px;color:#003366"><a href="<?php echo base_url(); ?>admin_invite/check/<?php echo $id; ?>/<?php echo $job_alias; ?>/<?php echo $hash; ?>"> <?php echo $job_name; ?></a></td>
                                                    </tr>
                                                 </tbody>
                                            </table>
                                              <table style="width:640px;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#003366;text-align:left">
                                              ...
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Language</th>
                                              ...
                                              <tbody>
                                                 <tr>
                                                     ...
                                                     <td style="background:#efefef;padding:10px;color:#003366"> <?php echo $lang_from; ?> TO <?php echo $lang_to; ?> </td>
                                              ...
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Invite Description</th>
                                              ...
                                              <tbody>
                                                 <tr>
                                                     ...
                                                     <td style="background:#efefef;padding:10px;color:#003366"> <?php echo $description; ?> </td>
                                                    ...
                                                    <tbody><tr>
                                                        <td width="492" style="width:494px;text-align:left">
                                                            <span style="color:#003366;font-family:Helvetica,Arial,sans-serif;font-size:14px;line-height:25px;margin:30px 0;padding:0">
                                                                Job is ready for Bid
                                                            </span>
                                                        </td>
                                                        <td width="88">
                                                       
                                                            <a style="padding: 10px 15px;background: #4479BA;color: #FFF;" href="<?php echo base_url(); ?>admin_invite/check/<?php echo $id; ?>/<?php echo $job_alias; ?>/<?php echo $hash; ?>" target="_blank">Bid Now
