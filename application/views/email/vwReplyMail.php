                                    ...
                                    <tr style="width:100%;margin:0;padding:0">
                                        <td colspan="4" style="border:1px solid #d4d4d4;width:100%;background:white;border-radius:10px;padding:20px;text-align:center" align="center">
                                            ...
                                            <p style="color:#003366;font-family:Helvetica,Arial,sans-serif;font-size:18px;margin:0 0 5px;padding:0;text-align:left">
                                             ...
                                             <?php echo $name ?> is send a  reply for <?php echo $job_title ?> Job related message
                                            </p>
                                            ...
                                            <table style="width:640px;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#003366;text-align:left">
                                              ...
                                              <tbody>
                                                 <tr>
                                                     ...
                                                     <td style="background:#efefef;padding:10px;color:#003366"> <?php echo $name; ?></td>
                                              ...
                                              <tbody>
                                                 <tr>
                                                     ...
                                                     <td style="background:#efefef;padding:10px;color:#003366"> <?php echo $email; ?></td>
                                              ...
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Reply Message</th>
                                              ...
                                              <tbody>
                                                 <tr>
                                                     ...
                                                     <td style="background:#efefef;padding:10px;color:#003366"> <?php echo $reply; ?> </td>
