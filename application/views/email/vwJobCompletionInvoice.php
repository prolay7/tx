...
<tr style="width:100%;margin:0;padding:0">
    <td colspan="4"
        ...
        <table style="width:640px;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#003366;text-align:left">
            <thead>
            <tr>
                <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:100%;font-size:13px">
                    Your Invoice Details Are Follows :
                </th>
        ...
        <table style="width:636px;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#003366;text-align:left;border: 1px solid rgb(32, 140, 229);  margin-left: 2.5px; margin-top: -2px;">
            ...
            <tr>
                ...
                <td style="background:#efefef;padding:10px;color:#003366"><a
                            href="<?php echo base_url(); ?>translator/invoice"><?php echo $job_title; ?></a></td>
            </tr>
            <tr>
                <td style="background:#efefef;padding:10px;color:#003366">Bid price:
                </td>
                <td style="background:#efefef;padding:10px;color:#003366"><?php echo '$' . $bid_price; ?></td>
            </tr>
            <tr>
                <td style="background:#efefef;padding:10px;color:#003366">Invoice No:
                </td>
                <td style="background:#efefef;padding:10px;color:#003366"><?php echo $invoice_id; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="background:#efefef;padding:10px;color:#003366">Completion Date:
                </td>
                <td style="background:#efefef;padding:10px;color:#003366"><?php echo date("jS F ,Y", strtotime($complete_date)); ?></td>
            </tr>
            <!--<tr>
<td style="background:#efefef;padding:10px;color:#003366">Completion Time:
</td>                                                   
<td style="background:#efefef;padding:10px;color:#003366"><?php //echo $comp_time/1440; ?>Days</td>
</tr>-->
            <!--<tr>
<td style="background:#efefef;padding:10px;color:#003366"> Invoice Description:
</td>                                                   
<td style="background:#efefef;padding:10px;color:#003366"><?php //echo $invoice_desc; ?></td>
</tr>-->

            </tbody>
        </table>
        <a href="<?php echo base_url(); ?>translator/invoice" style="margin: 20px 0;padding: 10px 15px;float: right;background: #208ce5;color: #fff;font-family: sans-serif;text-decoration: none;font-size: 12px;font-weight: 600;border-radius: 2px;border: 1px solid #1e80d0;box-shadow: rgba(0,0,0,0.4) 1px 2px 10px 0px;">View Invoices</a>
