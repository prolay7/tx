                            ...
                            <td style="text-align:center">
                                ...
                                <table style="width:680px;margin:0 auto;padding:0" align="center" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        ...
                                        <td style="height:34px;margin:0;width:151px;">
                                            <a href="#" target="_blank">
                                                <img class="CToWUd" src="<?php echo base_url() ?>includes/images/Logo.png" style="width:351px;min-height:34px;border:0" alt="Translator Exchange">
                                            </a>
                                        </td>
