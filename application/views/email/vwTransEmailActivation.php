                                            ...
                                            <p style="text-align:left">
                                                    ...
                                                    <tbody><tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a style="padding: 10px 15px;background: #4479BA;color: #FFF;" href="<?php echo base_url(); ?>translator/verify/<?php echo $translator_id; ?>/<?php echo $hash; ?>" target="_blank">Active Now
