...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 ...
 <td style="background:#efefef;padding:10px;color:#003366"> <a href="<?php echo base_url(); ?>translator/invoice"><?php echo $job_name; ?></a></td>
                                              ...
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Job Completed</th>
                                   ...
                                   <td style="background:#efefef;padding:10px;color:#003366"><?php echo date("jS F ,Y", strtotime($job_created));?></td>                             
                                            ...
                                            <table style="width:640px;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#003366;text-align:left">
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Job Invoice</th>
                                   ...
                                   <td style="background:#efefef;padding:10px;color:#003366"><?php echo $invoice; ?></td>                             
                                                    </tr>
                                                 </tbody>
                                            </table>
                                            <table style="width:640px;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#003366;text-align:left">
                                              <thead>
                                                <tr>
                                                 <th style="background:#208ce5;color:#fff;font-weight:normal;text-align:left;padding:10px;width:260px;font-size:13px">Bid Price</th>
                                   ...
                                   <td style="background:#efefef;padding:10px;color:#003366"><?php echo $price; ?>&nbsp;$</td>                             
                                                    </tr>
                                                 </tbody>
                                            </table>
                                                    ...
                                                    <tbody><tr>
                                                        <td width="492" style="width:494px;text-align:left">
                                                            <span style="color:#003366;font-family:Helvetica,Arial,sans-serif;font-size:14px;line-height:25px;margin:30px 0;padding:0">
                                                               Invoice is ready for view.
                                                            </span>
                                                        </td>
                                                        <td width="88">
                                                       
                                                            <a style="padding: 10px 15px;background: #4479BA;color: #FFF;" href="<?php echo base_url(); ?>translator/invoice" target="_blank">View Invoices
