...
if(isset($translator_id) && $translator_id != '') {
    ...
    <ul id="navigation">
        ...
        <li class="drpdn">
            <a href="<?php echo base_url(). 'translator/dashboard'; ?>" class="menuclass">My Account</a>
            <ul class="acddr">
        ...
        <li><a href="<?php echo base_url().'front/jobs';?>" class="menuclass" ><i class="ace-icon fa fa-share-square-o"></i>Jobs</a></li>
         <li>
              <a href="javascript: void(0)" id="ace-support-btn" class="myButton" style="top: 21px; display: inline"><i class="ace-icon fa fa-life-ring bigger-130" style="margin-right: 5px;"></i>Report Technical Issue</a>
          </li>
