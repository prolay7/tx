      ...
      <section class="inner">
        ...
        <div id="footer-menu">
          ...
          <div id="fol-menu" class="footer-menu">
              <h2>Follow Us</h2>
              <ul>                
                <li><a href="<?php echo $fetch6->twitter; ?>" target="blank"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a></li>
                <li><a href="<?php echo $fetch6->facebook; ?>" target="blank"><i class="fa fa-facebook" aria-hidden="true"></i> Facebook</a></li>
                <li><a href="<?php echo $fetch6->youtube; ?>" target="blank"><i class="fa fa-youtube" aria-hidden="true"></i> Youtube</a></li>
              </ul>
            </div>
