...
$config['base_url'] .= str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']);; //$ark_root;
...
define('HTTP_DOCS_PATH_ADMIN', $config['base_url'].'docs/');



define('HTTP_FRONT_CSS_PATH', $config['base_url'].'includes/css/');

define('HTTP_FRONT_IMAGES_PATH', $config['base_url'].'includes/images/');

define('HTTP_FRONT_JS_PATH', $config['base_url'].'includes/js/');

define('HTTP_FRONT_ASSETS_PATH_ADMIN', $config['base_url'].'includes/');

define('CONTACT_FROM','contact@translatorexchange.com');
...
$config['sess_time_to_update']	= 500000000000000000000000;
